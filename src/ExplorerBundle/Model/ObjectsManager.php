...
class ObjectsManager implements ModelManagerInterface, LockInterface
{
    ...
    {
        return $this->getConnector()->getObjectFields($this->ObjectType);
    }
    ...
    public function update($object)
    {
        ...
        try {
            ...
            // Write Object Data      
            $this->getConnector()
                    ->setObject($this->ObjectType, $object->id, $object->getArrayCopy());        
        } catch (\PDOException $e) {
            throw new ModelManagerException(
    ...
    public function delete($object)
    {
        ...
        if (!empty(Splash::log()->err)) {
            throw new ModelManagerException(
                sprintf('Failed to delete object: %s', PHP_EOL . implode(PHP_EOL, Splash::log()->err))
            );
        }
    }
